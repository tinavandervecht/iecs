...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 08, 2016 at 06:32 PM
...
INSERT INTO `tbl_admin` (`admin_id`, `admin_username`, `admin_pw`, `admin_name`) VALUES
(1, 'admin1', 'adminpw', 'Admin');
...
(6, 'John Doe\'s Company', 'johndoe@johndoe.ca', '000-000-0000', 'doe', '2016-11-17 20:54:33', 'John Doe', '2016-11-17 20:54:33', 1),
...
CREATE TABLE `tbl_estimates` (
  ...
  `estimate_modifiedDate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
(1, 1, '', '2016-10-31 11:37:38', '', 'Not Specified', 'Not Specified', 1, 'Fansawe College, London, Ontario, Canada', '2.00', '6.00', '0.00', '1.00', 3, '1.00', 3, '22.00', '80.00', '1.00', '2.00', 4, 'Soil Type and Related Conditions', '2016-11-17 21:17:27', ''),
(2, 2, '', '2016-10-11 11:02:47', '', 'Not Specified', 'Not Specified', 1, 'Adam\'s House, Oakville, Ontario, Canada', '41.00', '57.00', '27.00', '13.00', 2, '127.00', 2, '98.00', '21.00', '87.00', '87.00', 6, 'Soil Type and Related Conditions', '2016-11-17 21:17:27', ''),
(3, 1, '', '2016-10-17 13:35:27', '', 'Not Specified', 'Not Specified', 1, 'Location', '20.00', '282.00', '21.00', '291.00', 1, '291.00', 1, '291.00', '291.00', '291.00', '291.00', 1, 'Text', '2016-11-17 21:17:27', ''),
(4, 6, 'John Doe\'s Estimate #1', '2016-11-17 15:58:11', '', 'Not Specified', 'Not Specified', 1, 'John Doe\'s House', '11.00', '11.00', '22.00', '33.00', 1, '22.00', 1, '22.00', '22.00', '22.00', '22.00', 1, 'Cool Soil Type', '2016-11-17 21:17:27', ''),
(5, 6, 'John Doe\'s Estimate #2', '2016-11-17 15:58:11', '', 'Not Specified', 'Not Specified', 1, 'John Doe\'s Cottage', '11.00', '11.00', '11.00', '11.00', 1, '11.00', 1, '11.00', '11.00', '11.00', '11.00', 1, 'Some soil stuff.', '2016-11-17 21:17:27', ''),
(6, 6, 'John Doe\'s Estimate #3', '2016-11-17 15:59:54', '', 'Not Specified', 'Not Specified', 1, 'John Doe\'s Apartment', '11.00', '11.00', '11.00', '11.00', 1, '11.00', 1, '11.00', '11.00', '11.00', '11.00', 1, 'Soil soil soil', '2016-11-17 21:17:27', ''),
(7, 6, 'John Doe\'s Estimate #4', '2016-11-17 15:59:54', '', 'Not Specified', 'Not Specified', 1, 'John Doe\'s Park', '11.00', '11.00', '11.00', '11.00', 1, '11.00', 1, '11.00', '11.00', '11.00', '11.00', 1, 'Soil soil soil', '2016-11-17 21:17:27', ''),
(8, 6, 'Adam\'s Project', '2016-11-24 14:43:40', 'Soon', '2241 Carpenters', 'Adam Luxton', 1, 'Oakville, Ontario', '11.11', '11.11', '11.11', '11.11', 1, '11.11', 1, '11.11', '11.11', '11.11', '11.11', 1, 'Hello', '2016-11-24 19:43:40', 'Here are some comments'),
(9, 6, 'Project 2', '2016-11-25 11:10:42', 'Soon', '1111 Somewhere', 'Adam', 1, 'Somewhere', '99.66', '11.22', '0.12', '0.12', 1, '11.11', 1, '11.11', '11.11', '11.11', '11.11', 1, 'Text', '2016-11-25 16:10:42', 'Text'),
(10, 6, 'Adam\'s Project 2', '2016-11-25 06:30:42', 'Soon', '2241 Carpenters', 'Adam Luxton', 1, 'Oakville, Ontario', '11.11', '11.11', '11.11', '0.12', 1, '11.11', 1, '11.11', '11.11', '11.11', '11.11', 1, 'Hello', '2016-11-25 18:30:42', 'Comments'),
(11, 6, 'Project 2', '2016-12-01 05:36:12', '', '1111 Somewhere', 'Bob', 1, 'Somewhere', '99.66', '11.22', '0.12', '0.12', 1, '11.11', 1, '11.11', '11.11', '11.11', '11.11', 1, 'Text', '2016-12-01 17:36:12', 'comments'),
(12, 6, 'Project 3', '2016-12-06 05:32:53', '', '1111 Somewhere', 'Bob', 1, 'Somewhere', '99.66', '11.22', '0.12', '0.12', 1, '11.11', 1, '11.11', '11.11', '11.11', '11.11', 1, 'Text', '2016-12-06 17:32:53', 'Comment new'),
(13, 6, 'New one', '2016-12-06 05:33:58', '', 'Not Specified', 'Not Specified', 1, 'John Doe\'s House', '11.00', '11.00', '22.00', '33.00', 1, '22.00', 1, '22.00', '22.00', '22.00', '22.00', 1, 'Cool Soil Type', '2016-12-06 17:33:58', '');
...
--
ALTER TABLE `tbl_estimates`
  MODIFY `estimate_id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
