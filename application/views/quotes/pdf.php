...
<body>
    <div class="header">
        <div class="logo">
            <img src="<?php echo base_url('img/pdf-logo.png');?>" />
        </div>
        <div class="content">
            <h1 class="green-text">IECS ENVIRONMENTAL INC.</h1>
            <p>
                <strong>Head Office: 22295 Hoskins Line, Rodney, ON N0L 2C0</strong>
            </p>
            <p>
                Alberta Office: #300-160 Quarry Park Blvd. SE, Calgary, AB T2C 3G3
            </p>
            <p class="green-text phone-numbers"><strong>
                <span>Ph: 1-800-821-7462</span>
                <span>Fx: 1-866-496-1990</span>
            </strong></p>
        </div>
    </div>
    ...
    <div class="content">
        <div class="text-center">
            <img class="cc-logo" src="<?php echo base_url('img/pdf-cc-logo.png');?>" />
        </div>
        <p>
