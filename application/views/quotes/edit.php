      ...
      echo form_open('quotes/newQuote', $attributes);?>
          ...
          <section class="pagnation-page" id="2">
            ...
            <div class="columns small-12 medium-6 medium-clear">
              ...
              <div id="type"  class="clearfix">
                  ...
                  <input id="flowType" name="flowType" value="<?php echo $estimate['estimate_flowType'];?>"/>
              </div>
            </div>
              ...
              <div id="alignment"  class="clearfix">
                  ...
                  <input id="alignType" name="alignType" value="<?php echo $estimate['estimate_alignment'];?>"/>
              </div>
          ...
          <div class="columns small-12 medium-6">
              ...
              <label for="sourceType">
                ...
                <input id="sourceType" name="sourceType" value="<?php echo $estimate['estimate_outLetSource'];?>" />
              </div>
              ...
              <label for="soilType">
                ...
                <input id="soilType" name="soilType" value="<?php echo $estimate['estimate_soilType'];?>"/>
              </div>
            </div>
            <div class="columns small-12 medium-6">
