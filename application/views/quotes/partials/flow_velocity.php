<div class="row" id="flow_velocity_inputs">
    ...
    <div id="flow"  class="multi_input clearfix columns small-12 medium-6">
        ...
        <label for="flowFeet">
            <a href="#" class="tip"><span class="tooltip">Ensure the highest design flows are entered in cubic feet per second.</span>?</a>
    ...
    <div id="velocity" class="multi_input clearfix columns small-12 medium-6">
        ...
        <label for="velocityMeters">
            <a href="#" class="tip"><span class="tooltip">Input the pre-determined max velocity in m/s</span>?</a>
        ...
        <label for="velocityFeet">
            <a href="#" class="tip"><span class="tooltip">Input the pre-determined max velocity in f/s</span>?</a>
