...
<section class="row expanded collapse" id="login">
  ...
  <div class="small-12 small-centered text-center">
    ...
    <div id="formCont">
      ...
      echo form_open('adminpassword/reset/' . $token, $attributes);?>
        ...
        <input name="admin_pw" type="password" placeholder="Enter your Password"  title="Password with no spaces and between 6 &amp; 30 characters." pattern="[A-Za-z0-9\S]{6,30}" required="true"/>
        <?php echo form_error('admin_pw', '<p class="error">', '</p>');?>
