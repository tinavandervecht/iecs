<footer id="mobileMenu">
      <nav id="secondaryNav" class="four">
          ...
          <ul>
            ...
            <li><a href="<?php echo site_url('/quotes');?>" <?php if($current == "quotes"){echo "class='current'";}?>><img src="<?php echo base_url('img/paper_icon.svg');?>" class="navIcon"/><span class="navText">Designs</span></a></li>
