<footer id="mobileMenu">
      <nav id="secondaryNav" class="five">
          ...
          <ul>
            ...
            <li><a href="<?php echo site_url('/admin/estimates');?>" <?php if($current == "estimates"){echo "class='current'";}?>><img src="<?php echo base_url('img/paper_icon.svg');?>" class="navIcon"/><span class="navText">Analyses</span></a></li>
